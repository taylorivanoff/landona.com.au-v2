    ...
    <div id="about-us" class="py-32">
        <div class="flex flex-col items-center space-y-12">
            ...
            <div class="text-left max-w-3xl mx-auto py-8 space-y-8">
                ...
                <x-p>
                    Landona Conveyancing has been providing expert conveyancing services in NSW for over 20 years. Our mission is to make the property transfer process as seamless and stress-free as possible for our clients. Our experienced team ensures that every detail is handled with precision and care, allowing you to focus on the excitement of your property journey.
                </x-p>
...
{{--                <x-p>--}}
{{--                    Our team of licensed conveyancers is dedicated to providing personalized and professional service to every client. Get to know the people who will be handling your property transactions. We pride ourselves on our approachable and knowledgeable team members who are here to guide you every step of the way.--}}
{{--                </x-p>--}}
            </div>
        </div>
    </div>
