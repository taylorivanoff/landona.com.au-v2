<x-section id="conveyancing-made-easy">
    <div class="columns-1 lg:columns-2 lg:my-32">
        <div class="flex">
            <div class="basis-9/12 ml-auto mr-20">
                <svg class="opacity-90 hover:opacity-95" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g>
                        <path
                            ...
                            fill="#ccc"/>
                        <circle cx="271.81761" cy="63" r="63" fill="#ff7f00"/>
                        <path
        ...
        <div class="flex flex-col items-center">
            <div class="basis-1/2 space-y-8 mt-16">
                ...
                <x-content-button href="{{route('home')}}#property-and-land-services" id="see-our-services">
                    See Our Services ➜
                </x-content-button>
            </div>
        </div>
